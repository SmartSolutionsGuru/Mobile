...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "SmartSolutions.Mobile.Android.dll" comes first in this list. */
		"SmartSolutions.Mobile.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"Caliburn.Micro.Core.dll",
		"Caliburn.Micro.Platform.Core.dll",
		"Caliburn.Micro.Platform.dll",
		"Caliburn.Micro.Xamarin.Forms.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"SmartSolutions.Mobile.dll",
		"SQLite-net.dll",
